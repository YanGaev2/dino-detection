...
from .swin_v2_timm import build_swinv2_backbone, SWINV2_MODELS
...
def build_backbone(args):
    ...
    if args.backbone in ['resnet50', 'resnet101']:
    ...
    elif args.backbone.startswith('swinv2'):
        # Swin-V2 через timm
        pretrained = getattr(args, 'pretrained_backbone', False)
        backbone = build_swinv2_backbone(
        ...
        print(f"[INFO] Swin-V2 backbone loaded: {args.backbone}")
        print(f"[INFO] Feature channels: {bb_num_channels}")
    else:
