...
**************************************************************************************************
* Modified for PyTorch 2.x compatibility
**************************************************************************************************
*/
...
{
    // PyTorch 2.x: use TORCH_CHECK instead of AT_ASSERTM
    ...
    // PyTorch 2.x: use .is_cuda() instead of .type().is_cuda()
    ...
    for (int n = 0; n < batch/im2col_step_; ++n)
    {
        ...
        // PyTorch 2.x: use .scalar_type() instead of .type() in AT_DISPATCH_FLOATING_TYPES
        // PyTorch 2.x: use .data_ptr<scalar_t>() instead of .data<scalar_t>()
