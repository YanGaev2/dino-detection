...
// PyTorch 2.x compatibility: THC headers removed, use ATen/cuda/Atomic.cuh
#if defined(__CUDACC__) && (defined(__CUDA_ARCH__) || defined(__HIP__))
#include <ATen/cuda/Atomic.cuh>
#else
// Fallback for compilation outside CUDA context
#endif
